...
import os, urllib2, bisect, httplib, types, tempfile, logging
try:
...
class OpenerFactory:
    ...
    default_classes = [
        ...
        _googleappengine.HTTPHandler,  # derived from new AbstractHTTPHandler
        _googleappengine.HTTPDefaultErrorHandler,
        _googleappengine.HTTPRedirectHandler,  # bugfixed
        urllib2.FTPHandler,
        _file.FileHandler,
        # processors
        ...
        _googleappengine.HTTPCookieProcessor,
        _googleappengine.HTTPErrorProcessor,
        ]
    if hasattr(httplib, 'HTTPS'):
        #default_classes.append(_http.HTTPSHandler)
        default_classes.append(_googleappengine.HTTPSHandler)
    handlers = []
