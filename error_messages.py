...
league_already_started_leaving = "You may only leave a league before it had begun its draft. This one has already begun(or finished) its draft. You're stuck here for the rest of the season"